...
[CreateAssetMenu(fileName = "DefaultTactClip", menuName = "Bhaptics/Create Default TactClip")]
public class DefaultTactClip : TactClip
{
...
{
    DotMode = 1, PathMode = 2
}

[Serializable]
public enum Pos
{
    VestFront, VestBack, Head, RightForearm, LeftForearm, LeftHand, RightHand, LeftFoot, RightFoot
}
