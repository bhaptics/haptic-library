...
namespace Bhaptics.Tact.Unity
{
    ...
    [Obsolete("This script no longer updated. Recommend using TactClip.")]
    [Serializable]
    public class TactSource : MonoBehaviour
    {
        ...
        #region TactFile
        [Range(0.2f, 5f)] public float Intensity = 1;
        [Range(0.2f, 5f)] public float Duration = 1;
        public bool IsReflectTactosy;
        public float VestRotationAngleX;
        public float VestRotationOffsetY;
        [Range(0, 360)] public float TactFileOffsetX;
        [Range(-1, 1)] public float TactFileOffsetY;
            ...
            switch (FeedbackType)
            {
                ...
                case FeedbackType.TactFile:
                                                  ...
                                                  FeedbackFile.Type == BhapticsUtils.TypeTactosy2))
                    {
                        ...
                        {
                            player.RegisterTactFileStrReflected(reflectKey, FeedbackFile.Value);
        ...
        public void Play(RotationOption rotation)
        {
            ...
            player.SubmitRegisteredVestRotation(currentFeedbackFileKey, _key, rotation, new ScaleOption(Intensity, Duration));
        }
